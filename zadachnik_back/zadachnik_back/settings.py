"""
Django settings for zadachnik_back project.
...
ROOT_URLCONF = 'zadachnik_back.urls'
...
WSGI_APPLICATION = 'zadachnik_back.wsgi.application'

ASGI_APPLICATION = "zadachnik_back.asgi.application"
